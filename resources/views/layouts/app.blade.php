...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-dark bg-yellow shadow-sm nav-style">
        <div class="container">
            ...
            <div class="collapse navbar-collapse margin-left-100" id="navbarSupportedContent">
                <!-- Left Side Of Navbar -->
                @if(Auth::user())
                <ul class="navbar-nav mr-auto">
                    <li>
                        <a class="nav-link nav-link-color" href="/home">Home</a>
                    </li>
                    <li>
                        <a class="nav-link nav-link-color" href="/perfil">Perfil</a>
                    </li>
                    <li>
                        <a class="nav-link nav-link-color" href="/producto">Producto</a>
                    </li>
                </ul>
            @endif
